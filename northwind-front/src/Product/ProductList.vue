    ...
    <div class="">
       ...
       <el-input
        ...
        >
            ...
            <el-table-column prop="productName" label="nazwaProd"></el-table-column>
...
<!--                        <el-button @click="handleEdit(scope.row.id)" size="small" type="primary">Edytuj</el-button>-->
                  ...
                  <div class="buttons-order" v-if="order">

                    <el-button @click="handleAdd(scope.row)" size="small" type="primary">dodaj</el-button>
                    <!--                        <el-button @click="handleEdit(scope.row.id)" size="small" type="primary">Edytuj</el-button>-->
                  </div>
                </template>
            </el-table-column>
        ...
        <el-dialog
            ...
            <span>Czy na pewno chcesz usunąć : {{toDeleteId}}?</span>
      ...
      props: ['order'],
        ...
        methods: {
            loadProds: function () {
                ...
                this.$axios.get(this.$api + "/api/products", {})
                    .then(resp => {
